          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-1">
                ...
                <button className="rounded-full w-10 h-10 cursor-pointer bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 hover:text-red-700 hover:bg-red-300">
                  <svg
                    fill="currentColor"
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
          ...
          <div className="flex flex-col items-center w- max-w-xs p-4 bg-white rounded-3xl md:flex-row">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex flex-col items-center md:items-start ml-2">
                <h2 className="text-xl font-bold text-black">nihal</h2>
